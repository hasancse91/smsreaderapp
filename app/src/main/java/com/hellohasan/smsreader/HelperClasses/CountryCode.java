...
/**
 * Created by hasan on 5/13/16.
 */
public class CountryCode {
    private static Map<String , String > countryLookupMap = new HashMap<>();

    static {
        setCountryName();
    }
    private static void setCountryName(){
    ...
    public static String getCountryName(String countryCode){
        return  countryLookupMap.get(countryCode);
    }
